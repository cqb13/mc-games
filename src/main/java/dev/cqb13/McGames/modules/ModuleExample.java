...
public class ModuleExample extends Module {
     ...
     * If you want to access the setting from another class, simply make the setting
     * {@code public}, and use
     * {@link meteordevelopment.meteorclient.systems.modules.Modules#get(Class)} to
     * access the {@link Module} object.
     */
    ...
    public ModuleExample() {
        super(McGames.CATEGORY, "world-origin", "An example module that highlights the center of the world.");
    }

    /**
     * Example event handling method.
     * Requires {@link AddonTemplate#getPackage()} to be setup correctly, otherwise
     * the game will crash whenever the module is enabled.
     */
    @EventHandler
